...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Matias Ruiz Torres", "Trabajo-Final", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Trabajo-Final";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Trabajo-Final", null, { width: 640, height: 720 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 640, height: 720 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 640, 720, "null");
		#end
		#else
		create ();
		#end
